...
CREATE OR REPLACE AGENT ORIGENCE_LENDING_AGENT
  ...
  instructions:
    ...
    sample_questions:
      ...
      - question: "What is the default rate for auto loans?"
        answer: "I'll analyze the loan performance data filtered by auto loans to calculate the default rate."
      - question: "Predict default risk for auto loans in the portfolio"
        answer: "I'll use the loan default prediction model to analyze auto loans and provide risk distribution."
      - question: "Find underwriting notes mentioning debt-to-income concerns"
        answer: "I'll search the underwriting notes for debt-to-income related content."
      - question: "What are our policies on auto loan collateral requirements?"
        answer: "I'll search the compliance policies for auto loan collateral guidelines."
